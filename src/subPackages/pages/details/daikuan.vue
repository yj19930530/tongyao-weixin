<template>
  <view class="detail-content">
    <view class="fl-bt detail-item-content">
      ...
      <view class="mr-r-30 fz-14 item-right">{{form.loanType||'-'}}</view>
    </view>
    <view class="fl-bt detail-item-content">
    ...
    <view class="fl-bt detail-item-content">
      ...
      <view class="mr-r-30 fz-14 item-right">{{form.businessType||'-'}}</view>
    </view>
    <view class="fl-bt detail-item-content">
    ...
    <view class="fl-bt detail-item-content">
      ...
      <view class="mr-r-30 fz-14 item-right">{{form.intentionTerm||'-'}}</view>
    </view>
    <view class="fl-bt detail-item-content">
