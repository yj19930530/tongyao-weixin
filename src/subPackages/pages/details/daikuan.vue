<template>
  <view class="detail-content">
    ...
    <view class="fl-bt detail-item-content">
      ...
      <view class="mr-r-30 fz-14 item-right">{{ form.loanAmount || "-" }} 元</view>
    </view>
  </view>
</template>
<script>
